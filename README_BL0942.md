...
* Attribute ***0xF090***: _start_calibration_ – старт калибровки и статус

После пуска калибровки начинается отсчет 4-х циклов измерения BL0942 для накопления средних значений.
Через 4-ре цикла накопления усредненных измерений производится перерасчет выбранных типов коэффициентов для отображения значений в соответствующих единицах измерения.
